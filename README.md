...
- The scripts pauses for you to create the CNAME record according to the information given by this command.
- Resume the script after some minutes waiting (to be sure the DNS records are correctly written)
- Now the script tries the DNS-01 challenge
